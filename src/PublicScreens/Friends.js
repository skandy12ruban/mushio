...
<View style={{flexDirection:'row'}}>
   <Ionicons
          ...
          />
          <Text style={{color:theme === 'dark' ? 'white':'black',fontWeight:'bold',fontSize:20,marginTop:10,marginLeft:10}}>{'Artists'}</Text>
</View>
<View>
...
<View>
<Text style={{fontWeight:'bold',fontSize:20,color:theme === 'dark' ? 'white':'black',margin:5,marginLeft:40}}> All Artists ({artistArray.length})</Text>
 <FlatList
 data={artistArray}
 renderItem={Item}
 keyExtractor={item =>item._id}
