...
const About = () => {
  ...
  return (
    <SafeAreaView style={{alignSelf:'center',width:'100%',flex:2}}>
    ...
    <Text style={{color:'black'}}>The Mushio app has two modes, Mood Tracker and Entertainment, each with its unique features. 
      The application offers two profiles, a private and public profile, to the user.
       ...
       The private profile is focused on mood tracking, while the public profile is to share media and connect with others.
        Overall, the app aims to provide a comprehensive and enjoyable user experience</Text>
          ...
          <Text style={{fontWeight:'bold',color:'black',alignSelf:'center',padding:5}}>private account :</Text>
          <Text style={{color:'black'}}>In the private account, users can use the mood tracker feature for self-evaluation. 
          ...
          <Text style={{fontWeight:'bold',color:'black',alignSelf:'center',padding:5}}>public account : </Text>
          <Text style={{color:'black'}}> When a user switches to a public account, the entire display changes to show posts and options for adding posts, 
          ...
          <Text style={{fontWeight:'bold',color:'black',alignSelf:'center',padding:5}}>Privacy Policy : </Text>
          <Text style={{color:'black'}}> One of our main priorities is the privacy of our users,
             ...
             This privacy policy applies only to our online activities and is valid for users of our application with regards to information that they shared or collect in application.
              ...
              <Text style={{fontWeight:'bold',color:'black',alignSelf:'center',padding:5}}> consent: :</Text>
          <Text style={{color:'black'}}> By using our application , you hereby consent to our privacy policy and agree to its terms.
              ...
              <Text style={{color:'black'}}>5)Send you emails </Text>
               ...
               <Text style={{color:'black'}}>1. The Right to access :you have the right to access information of your personal data. </Text>
                  ...
                  <Text style={{color:'black'}}>3. The right to erasure :
                   ...
                   <Text style={{fontWeight:'bold',color:'black',alignSelf:'center',padding:5}}>  personal messaging :</Text>
               <Text style={{color:'black'}}>privacy and security plays a vital role in our application .our application aims to protect all personal data from all frauds and keep secure .</Text>
               <Text style={{fontWeight:'bold',color:'black',alignSelf:'center',padding:5,marginTop:10}}> Privacy and security :</Text>
               <Text style={{color:'black'}}>when a user chat with another user using mushio application . Only you and the person you’re communicating with can read or listen to what is sent. And nobody get access to read your chats .</Text>
               <Text style={{color:'black'}}>Your messages and calls are secured. </Text>
               <Text style={{color:'black'}}>if you make a request , we will get back to you as soon as possible. </Text>
               <Text style={{color:'black'}}>If you would like to exercise any of these rights , please contact us. </Text>
