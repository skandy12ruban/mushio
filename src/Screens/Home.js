...
const Home = (props) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: theme === 'dark' ? 'black' : '#f6f6f6', }}>
      ...
      <Text style={{ fontSize: 25, marginLeft: Metrics.rfv(20), color: theme === 'dark' ? 'white' : 'black', fontFamily: 'Montserrat-Bold', marginTop: 10 }}>Halo, <Text style={{ color: theme === 'dark' ? '#474242' : '#00B0FF', }}>{userInfo && userInfo.name}</Text></Text>
